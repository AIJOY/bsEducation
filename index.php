...
?>
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="<?php echo get_theme_file_uri("assets/img/faculty/1.jpg")?>"  class="img-rounded" />
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                     <img src="<?php echo get_theme_file_uri("assets/img/faculty/2.jpg")?>"  class="img-rounded" />
                   <h3 >JANE DEO ALEX</h3>
                 <hr />
               ...
               <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                     <div class="faculty-div">
                     <img src="<?php echo get_theme_file_uri("assets/img/faculty/3.jpg");?>" class="img-rounded" />
                   <h3 >RUBY DECORSA</h3>
                 <hr />
    ...
    <!-- FACULTY SECTION END-->
      <div id="course-sec" class="container set-pad">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6 " data-scroll-reveal="enter from the bottom after 0.4s" >
                 <img src="<?php echo get_theme_file_uri("assets/img/building.jpg");?>" class="img-thumbnail" />
           </div>
 ...
 <div class="container set-pad">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        <a href="#">  <img src="<?php echo get_theme_file_uri("assets/img/Social/facebook.png");?>" alt="" /> </a>
                     <a href="#"> <img src="<?php echo get_theme_file_uri("assets/img/Social/google-plus.png");?>" alt="" /></a>
                     <a href="#"> <img src="<?php echo get_theme_file_uri("assets/img/Social/twitter.png");?>" alt="" /></a>
                    </div>
                    </div>
